<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-4">
                    <h5 class="m-0 text-green-500  text-lg">My FSC Non-Conformances</h5>
                </div><!-- /.col -->
                ...
                <div class="col-sm-4">
                    <ol class="breadcrumb float-sm-right text-sm">
                        ...
                        <li class="breadcrumb-item active">My FSC Non-Conformances</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-12">
                    <div class="max-w-md mx-auto sm:max-w-7xl">
                        ...
                        <section class="m-1 p-2 w-12/12 flex flex-col rounded border sm:pt-0 text-sm">
                            @if($data == 0)
                            <h5 class="font-bold text-center text-green-900">My FSC Non-Conformances</h5>
                            @if($conformances->count()==0)
                            <p class="text-center text-orange-500 mt-2">No Received FSC Non-comformance</p>
                            @else
                            <table class="table">
                                ...
                                <section class="lg:w-8/12 sm:w-full">
                                    <div class="rounded bg-white overflow-hidden shadow-md px-2 py-2">
                                        ...
                                        <div class="flex justify-center">
                                            <h6 class="mt-2 font-bold">Corrective Action Reports.</h6>
                                        </div>
                                        ...
                                        <section class="p-2 w-full border rounded">
                                            ...
                                            <div class="rounded border mt-2 py-3 px-4">
                                                <div>
                                                    <label for="disabledSelect" class="text-green-500">Non Conformance FSC</label>
                                                    <p class="form-control-static">{!!$FSCnonconformance!!}</p>
                                                    {{-- added FSCnonconformance on nonconformance --}}
                                                </div>
                                            </div>
