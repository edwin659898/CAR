...
<head>
    ...
    <link rel="stylesheet" href="{{asset('parent/plugins/toastr/toastr.min.css')}}">
...
{{-- fsc non confomance un used --}}
                        ...
                        {{-- card fsc --}}
                        <li class="nav-item">
                            <a href="{{route('car.logsFSC')}}" class="nav-link {{ (request()->is('CAR-FSCLogs') || request()->is('Selected-CAR*')) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book text-white"></i>
                                <p class="text-white">
                                    CAR FSC logs
                                </p>
 ...
 */
    ...
    <script src="{{asset('parent/plugins/toastr/toastr.min.js')}}"></script>
    <!-- Bootstrap 4 -->
