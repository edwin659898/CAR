    ...
    <div class="relative">
        <div class="flex items-center justify-between mb-1">
            ...
            @if($this->activeFilters)
                <span class="text-sm text-blue-400 uppercase">@lang('Filter active')</span>
            @endif
        ...
        <div wire:loading.class="opacity-50" class="rounded-lg @unless($complex || $this->hidePagination) rounded-b-none @endunless shadow-lg bg-white max-w-screen overflow-x-scroll border-2  border-transparent @if($complex) rounded-b-none border-b-0 @endif">
            <div>
