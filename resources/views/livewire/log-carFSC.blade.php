<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <ol class="breadcrumb float-sm-right text-sm">
                        <li class="breadcrumb-item active"><a href="{{route('closed.carFSC')}}" class="font-bold">Closed CARs</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="rounded bg-white overflow-hidden shadow-md px-2 py-2">
                                        ...
                                        <section class="p-2 w-full border rounded">
                                            ...
                                            <form wire:submit.prevent="update">
                                                <div class="rounded border mt-2 py-3 px-4">
                                                    <div wire:ignore>
                                                        <label for="comms" class="text-green-500">Communication Comment</label>
                                                        <input id="comms" value="{{ $communication_comment }}" type="hidden" name="communication">
                                                        <trix-editor input="comms" name="content">Welcome Home</trix-editor>
                                                    </div>
                                                    @error('communication_comment') <span class="text-red-500">{{ $message }}</span> @enderror
                                                </div>

                                                <div class="rounded border mt-2 py-3 px-4">
                                                    <div wire:ignore>
                                                        <label for="hr" class="text-green-500">HR Comment</label>
                                                        <input id="hr" value="{{ $hr_comment }}" type="hidden" name="hr">
                                                        <trix-editor input="hr"></trix-editor>
                                                    </div>
                                                    @error('hr_comment') <span class="text-red-500">{{ $message }}</span> @enderror
                                                </div>

                                                <div class="rounded border mt-2 py-3 px-4">
                                                    <div wire:ignore>
                                                        <label for="mt" class="text-green-500">HOD Comment</label>
                                                        <input id="mt" value="{{ $mt_comment }}" type="hidden" name="mt">
                                                        <trix-editor wire:ignore input="mt"></trix-editor>
                                                    </div>
                                                    @error('mt_comment') <span class="text-red-500">{{ $message }}</span> @enderror
                                                </div>

                                                <div class="rounded border mt-2 py-3 px-4">
                                                    <div wire:ignore>
                                                        <label for="ft" class="text-green-500">Final Comment</label>
                                                        <input id="ft" value="{{ $final_comment }}" type="hidden" name="ft">
                                                        <trix-editor wire:ignore input="ft"></trix-editor>
                                                    </div>
                                                    @error('ft_comment') <span class="text-red-500">{{ $message }}</span> @enderror
                                                </div>
    ...
    <script>
        ...
        addEventListener("trix-blur", function(event) {
            @this.set('communication_comment', comms.getAttribute('value'))
            @this.set('hr_comment', hr.getAttribute('value'))
            @this.set('mt_comment', mt.getAttribute('value'))
            @this.set('final_comment', ft.getAttribute('value'))
        })
    </script>
