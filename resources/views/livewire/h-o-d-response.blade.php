                                ...
                                <section class="lg:w-8/12 sm:w-full">
                                    <div class="rounded bg-white overflow-hidden shadow-md px-2 py-2">
                                        ...
                                        <section class="p-2 w-full border rounded">
                                            ...
                                            <div class="rounded border mt-2 py-3 px-4">
                                                <div>
                                                    <label class="text-green-500">Cause <i wire:click="destroy({{$solution->id}})" class="text-red-500 hover:text-red-700 cursor-pointer fas fa-trash ml-2"></i></label>
                                                    <p class="form-control-static">{{$solution->cause}}</p>
                                                </div>
                                                <div>
                                            ...
                                            <div class="mt-2 flex justify-end">
                                                <a wire:click="update" class="items-center px-3 py-2 bg-green-500 border  rounded-md  text-xs cursor-pointer
                                                text-white hover:bg-green-700 focus:outline-none focus:border-gray-900
                                                 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                                    Save</a>
                                            </div>
