...
class LogCarFSC extends Component
{
    public $selected;
    ...
    public function update()
    {
        ...
        if ($this->mt_comment != '' || $this->hr_comment != '' || $this->communication_comment != '') {
            FSCAudits::findOrFail($this->selected)->update([
    ...
    {
        $nonConformance = FSCAudits::with('responses', 'creator', 'manager', 'HODs', 'sayings', 'images')->findOrFail($this->selected);
        return view('livewire.log-carFSC', [
