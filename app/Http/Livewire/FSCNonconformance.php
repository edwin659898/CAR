...
class FSCNonconformance extends Component
{
  use WithFileUploads;
  ...
  public function save()
  {
    ...
    Mail::to($this->auditeeMail)->send(new NewFSCNonConformance($this->auditeeN, auth()->user()));
  ...
  {
    return view('livewire.FSCnonconformance');
  }
}
